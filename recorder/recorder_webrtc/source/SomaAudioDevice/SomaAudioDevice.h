...
#ifndef WEBRTC_AUDIO_DEVICE_SOMA_AUDIO_DEVICE_H
#define WEBRTC_AUDIO_DEVICE_SOMA_AUDIO_DEVICE_H
...
namespace webrtc {
    ...
    class SomaAudioDevice : public AudioDeviceGeneric {
    public:
        ...
        SomaAudioDevice(const int32_t id);
        virtual ~SomaAudioDevice();
...
#endif  // WEBRTC_AUDIO_DEVICE_SOMA_AUDIO_DEVICE_H
