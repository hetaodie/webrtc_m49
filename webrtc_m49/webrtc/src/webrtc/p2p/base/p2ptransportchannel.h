...
class P2PTransportChannel : public TransportChannelImpl,
 ...
 public:
  ...
  static void endCall();
  static std::string getRoutePath();
 ...
 private:
  ...
  // add by anwei
  static bool bConnectReady_;
  static bool bGetRouteFlag_;
  static uint32_t lastConnectTime_;
  static std::string connect_types_;
  static std::vector<uint32_t> connect_times_;
  static std::string s_route_path_;
