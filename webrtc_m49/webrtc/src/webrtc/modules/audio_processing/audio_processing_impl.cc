...
int AudioProcessingImpl::WriteInitMessage() {
  ...
  msg->set_num_input_channels(static_cast<google2::protobuf::int32>(
      formats_.api_format.input_stream().num_channels()));
  msg->set_num_output_channels(static_cast<google2::protobuf::int32>(
      formats_.api_format.output_stream().num_channels()));
  msg->set_num_reverse_channels(static_cast<google2::protobuf::int32>(
      formats_.api_format.reverse_input_stream().num_channels()));
#else
