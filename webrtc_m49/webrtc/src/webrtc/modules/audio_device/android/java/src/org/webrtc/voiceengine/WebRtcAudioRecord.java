...
public class  WebRtcAudioRecord {//add public by wafer
  ...
  // ********** add by wafer **********
  public static void setAudioSourceType(int type) {
    audioSourceType = type;
  }
  private static int audioSourceType = AudioSource.VOICE_COMMUNICATION;
  ...
  public static interface Observer {
    public final int AudioRecord_Initialize_Failed = 0;

    public void onAudioRecordError(int errorCode);
  }
  // ********** end, add by wafer **********
 ...
 /*     audioRecord = new AudioRecord(AudioSource.VOICE_COMMUNICATION,
                                    ...
                                    AudioFormat.ENCODING_PCM_16BIT,
                                    bufferSizeInBytes);*/
      audioRecord = new AudioRecord(audioSourceType,
                                    sampleRate,
                                    AudioFormat.CHANNEL_IN_MONO,
                                    AudioFormat.ENCODING_PCM_16BIT,
                                    bufferSizeInBytes); // modified by wafer
    ...
    if (audioRecord == null ||
      ...
      if (observer != null)
        observer.onAudioRecordError(Observer.AudioRecord_Initialize_Failed);// add by wafer
