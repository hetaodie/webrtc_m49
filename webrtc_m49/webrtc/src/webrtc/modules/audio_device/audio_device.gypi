          ...
          'conditions': [
            ...
            ['OS=="ios"', {
              ...
              'sources': [
                ...
                'ios_old/audio_device_ios_old.h',
                'ios_old/audio_device_ios_old.mm',
                'ios_old/audio_device_utility_ios.cc',
                'ios_old/audio_device_utility_ios.h',
                'ios_old/audio_device_utility.cc',
                'ios_old/audio_device_utility.h',
                'ios_old/event_posix.cc',
                'ios_old/event_posix.h',
                'ios_old/event_wrapper.h',
                'ios_old/event.cc',
                'ios_old/thread_posix.cc',
                'ios_old/thread_posix.h',
                'ios_old/thread_wrapper.h',
                'ios_old/thread.cc',
              ],
              'xcode_settings': {
