...
class AudioDeviceIOS_Old : public webrtc::AudioDeviceGeneric {
 public:
  AudioDeviceIOS_Old(const int32_t id);
  ~AudioDeviceIOS_Old();
  ...
  virtual int32_t SetPlayoutDevice(webrtc::AudioDeviceModule::WindowsDeviceType device);
  ...
  virtual int32_t SetPlayoutBuffer(const webrtc::AudioDeviceModule::BufferType type,
                                   uint16_t sizeMS);
  virtual int32_t PlayoutBuffer(webrtc::AudioDeviceModule::BufferType& type,
