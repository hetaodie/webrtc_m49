...
#include "webrtc/modules/audio_device/ios_old/audio_device_ios_old.h"

#include "webrtc/modules/audio_device/ios_old/thread_wrapper.h"
#include "webrtc/system_wrappers/include/trace.h"

namespace webrtc2 {
AudioDeviceIOS_Old::AudioDeviceIOS_Old(const int32_t id)
    :
...
AudioDeviceIOS_Old::~AudioDeviceIOS_Old() {
...
void AudioDeviceIOS_Old::AttachAudioBuffer(webrtc::AudioDeviceBuffer* audioBuffer) {
...
int32_t AudioDeviceIOS_Old::ActiveAudioLayer(
...
int32_t AudioDeviceIOS_Old::Init() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
    ...
    if (_captureWorkerThread == NULL) {
        ...
        if (_captureWorkerThread == NULL) {
            webrtc::WEBRTC_TRACE(webrtc::kTraceCritical, webrtc::kTraceAudioDevice,
        ...
        webrtc::WEBRTC_TRACE(webrtc::kTraceDebug, webrtc::kTraceAudioDevice,
                     _id, "CaptureWorkerThread started (res=%d)", res);
    } else {
        webrtc::WEBRTC_TRACE(webrtc::kTraceWarning, webrtc::kTraceAudioDevice,
...
int32_t AudioDeviceIOS_Old::Terminate() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
bool AudioDeviceIOS_Old::Initialized() const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
    return (_initialized);
}

int32_t AudioDeviceIOS_Old::InitSpeaker() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
    ...
    if (!_initialized) {
        webrtc::WEBRTC_TRACE(webrtc::kTraceError, webrtc::kTraceAudioDevice,
                     _id, "  Not initialized");
        return -1;
    }
...
int32_t AudioDeviceIOS_Old::InitMicrophone() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
bool AudioDeviceIOS_Old::SpeakerIsInitialized() const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
    return _speakerIsInitialized;
}

bool AudioDeviceIOS_Old::MicrophoneIsInitialized() const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
    return _micIsInitialized;
}

int32_t AudioDeviceIOS_Old::SpeakerVolumeIsAvailable(bool& available) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::SetSpeakerVolume(uint32_t volume) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::SetSpeakerVolume(volume=%u)", volume);

    webrtc::WEBRTC_TRACE(webrtc::kTraceWarning, webrtc::kTraceAudioDevice, _id,
                 "  API call not supported on this platform");
    return -1;
}

int32_t AudioDeviceIOS_Old::SpeakerVolume(uint32_t& volume) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t
    AudioDeviceIOS_Old::SetWaveOutVolume(uint16_t volumeLeft,
                                     uint16_t volumeRight) {
    webrtc::WEBRTC_TRACE(
        webrtc::kTraceModuleCall,
        webrtc::kTraceAudioDevice,
        _id,
        "AudioDeviceIOS_Old::SetWaveOutVolume(volumeLeft=%u, volumeRight=%u)",
...
int32_t
AudioDeviceIOS_Old::WaveOutVolume(uint16_t& /*volumeLeft*/,
...
int32_t
    AudioDeviceIOS_Old::MaxSpeakerVolume(uint32_t& maxVolume) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::MinSpeakerVolume(
...
int32_t
    AudioDeviceIOS_Old::SpeakerVolumeStepSize(uint16_t& stepSize) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::SpeakerMuteIsAvailable(bool& available) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::SetSpeakerMute(bool enable) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::SpeakerMute(bool& enabled) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::MicrophoneMuteIsAvailable(bool& available) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::SetMicrophoneMute(bool enable) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::MicrophoneMute(bool& enabled) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::MicrophoneBoostIsAvailable(bool& available) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::SetMicrophoneBoost(bool enable) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::SetMicrophoneBoost(enable=%u)", enable);

    if (!_micIsInitialized) {
        webrtc::WEBRTC_TRACE(webrtc::kTraceError, webrtc::kTraceAudioDevice, _id,
...
int32_t AudioDeviceIOS_Old::MicrophoneBoost(bool& enabled) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
    if (!_micIsInitialized) {
        webrtc::WEBRTC_TRACE(webrtc::kTraceError, webrtc::kTraceAudioDevice, _id,
...
int32_t AudioDeviceIOS_Old::StereoRecordingIsAvailable(bool& available) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::SetStereoRecording(bool enable) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::SetStereoRecording(enable=%u)", enable);
...
int32_t AudioDeviceIOS_Old::StereoRecording(bool& enabled) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::StereoPlayoutIsAvailable(bool& available) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::SetStereoPlayout(bool enable) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::SetStereoPlayout(enable=%u)", enable);
...
int32_t AudioDeviceIOS_Old::StereoPlayout(bool& enabled) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::SetAGC(bool enable) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::SetAGC(enable=%d)", enable);
...
bool AudioDeviceIOS_Old::AGC() const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::MicrophoneVolumeIsAvailable(bool& available) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::SetMicrophoneVolume(uint32_t volume) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::SetMicrophoneVolume(volume=%u)", volume);
...
int32_t
    AudioDeviceIOS_Old::MicrophoneVolume(uint32_t& volume) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t
    AudioDeviceIOS_Old::MaxMicrophoneVolume(uint32_t& maxVolume) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t
    AudioDeviceIOS_Old::MinMicrophoneVolume(uint32_t& minVolume) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t
    AudioDeviceIOS_Old::MicrophoneVolumeStepSize(
...
int16_t AudioDeviceIOS_Old::PlayoutDevices() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::SetPlayoutDevice(uint16_t index) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::SetPlayoutDevice(index=%u)", index);
...
int32_t
    AudioDeviceIOS_Old::SetPlayoutDevice(webrtc::AudioDeviceModule::WindowsDeviceType) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceWarning, webrtc::kTraceAudioDevice, _id,
...
int32_t
    AudioDeviceIOS_Old::PlayoutDeviceName(uint16_t index,
                                         char name[webrtc::kAdmMaxDeviceNameSize],
                                         char guid[webrtc::kAdmMaxGuidSize]) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::PlayoutDeviceName(index=%u)", index);
...
int32_t
    AudioDeviceIOS_Old::RecordingDeviceName(uint16_t index,
                                           char name[webrtc::kAdmMaxDeviceNameSize],
                                           char guid[webrtc::kAdmMaxGuidSize]) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::RecordingDeviceName(index=%u)", index);
...
int16_t AudioDeviceIOS_Old::RecordingDevices() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);

    return (int16_t)1;
}

int32_t AudioDeviceIOS_Old::SetRecordingDevice(uint16_t index) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::SetRecordingDevice(index=%u)", index);
...
int32_t
    AudioDeviceIOS_Old::SetRecordingDevice(
...
int32_t AudioDeviceIOS_Old::SetLoudspeakerStatus(bool enable) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceInfo, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::SetLoudspeakerStatus(enable=%d)", enable);
...
int32_t AudioDeviceIOS_Old::GetLoudspeakerStatus(bool &enabled) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceInfo, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::SetLoudspeakerStatus(enabled=?)");
...
int32_t AudioDeviceIOS_Old::PlayoutIsAvailable(bool& available) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::RecordingIsAvailable(bool& available) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::InitPlayout() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);

    webrtc::CriticalSectionScoped lock(&_critSect);

    if (!_initialized) {
        webrtc::WEBRTC_TRACE(webrtc::kTraceError, webrtc::kTraceAudioDevice, _id, "  Not initialized");
        return -1;
    }
...
bool AudioDeviceIOS_Old::PlayoutIsInitialized() const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
    return (_playIsInitialized);
}

int32_t AudioDeviceIOS_Old::InitRecording() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
bool AudioDeviceIOS_Old::RecordingIsInitialized() const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
    return (_recIsInitialized);
}

int32_t AudioDeviceIOS_Old::StartRecording() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
    ...
    if (!_playing) {
        // Start Audio Unit
        webrtc::WEBRTC_TRACE(webrtc::kTraceDebug, webrtc::kTraceAudioDevice, _id,
                     "  Starting Audio Unit");
        OSStatus result = AudioOutputUnitStart(_auVoiceProcessing);
        if (0 != result) {
            webrtc::WEBRTC_TRACE(webrtc::kTraceCritical, webrtc::kTraceAudioDevice, _id,
...
int32_t AudioDeviceIOS_Old::StopRecording() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
bool AudioDeviceIOS_Old::Recording() const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
    return (_recording);
}

int32_t AudioDeviceIOS_Old::StartPlayout() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::StopPlayout() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
bool AudioDeviceIOS_Old::Playing() const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "%s", __FUNCTION__);
    return (_playing);
}
...
// ----------------------------------------------------------------------------
int32_t AudioDeviceIOS_Old::ResetAudioDevice() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::PlayoutDelay(uint16_t& delayMS) const {
    delayMS = _playoutDelay;
    return 0;
}

int32_t AudioDeviceIOS_Old::RecordingDelay(uint16_t& delayMS) const {
    delayMS = _recordingDelay;
    return 0;
}

int32_t
    AudioDeviceIOS_Old::SetPlayoutBuffer(const webrtc::AudioDeviceModule::BufferType type,
                                     uint16_t sizeMS) {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id,
                 "AudioDeviceIOS_Old::SetPlayoutBuffer(type=%u, sizeMS=%u)",
                 type, sizeMS);
...
int32_t
    AudioDeviceIOS_Old::PlayoutBuffer(webrtc::AudioDeviceModule::BufferType& type,
                                     uint16_t& sizeMS) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);

    type = webrtc::AudioDeviceModule::kAdaptiveBufferSize;
...
int32_t AudioDeviceIOS_Old::CPULoad(uint16_t& /*load*/) const {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
bool AudioDeviceIOS_Old::PlayoutWarning() const {
    return (_playWarning > 0);
}

bool AudioDeviceIOS_Old::PlayoutError() const {
    return (_playError > 0);
}

bool AudioDeviceIOS_Old::RecordingWarning() const {
    return (_recWarning > 0);
}

bool AudioDeviceIOS_Old::RecordingError() const {
    return (_recError > 0);
}

void AudioDeviceIOS_Old::ClearPlayoutWarning() {
    _playWarning = 0;
}

void AudioDeviceIOS_Old::ClearPlayoutError() {
    _playError = 0;
}

void AudioDeviceIOS_Old::ClearRecordingWarning() {
    _recWarning = 0;
}

void AudioDeviceIOS_Old::ClearRecordingError() {
    _recError = 0;
}
...
int32_t AudioDeviceIOS_Old::InitPlayOrRecord() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceModuleCall, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
...
int32_t AudioDeviceIOS_Old::ShutdownPlayOrRecord() {
    webrtc::WEBRTC_TRACE(webrtc::kTraceInfo, webrtc::kTraceAudioDevice, _id, "%s", __FUNCTION__);
    ...
    if (NULL != _auVoiceProcessing) {
        ...
        if (0 != result) {
            webrtc::WEBRTC_TRACE(webrtc::kTraceWarning, webrtc::kTraceAudioDevice, _id,
                         "  Error Uninitializing Audio Unit (result=%d)", result);
        }
    ...
    result = [session setActive:NO withOptions:AVAudioSessionSetActiveOptionNotifyOthersOnDeactivation  error:&error];

    if (error != nil) {
        webrtc::WEBRTC_TRACE(webrtc::kTraceWarning, webrtc::kTraceAudioDevice, _id,
                     "Error unActivating audio session");
    }
...
OSStatus
    AudioDeviceIOS_Old::RecordProcess(void *inRefCon,
                                  AudioUnitRenderActionFlags *ioActionFlags,
                                  const AudioTimeStamp *inTimeStamp,
                                  UInt32 inBusNumber,
                                  UInt32 inNumberFrames,
                                  AudioBufferList *ioData) {
    AudioDeviceIOS_Old* ptrThis = static_cast<AudioDeviceIOS_Old*>(inRefCon);
...
OSStatus
    AudioDeviceIOS_Old::RecordProcessImpl(AudioUnitRenderActionFlags *ioActionFlags,
                                      const AudioTimeStamp *inTimeStamp,
...
OSStatus
    AudioDeviceIOS_Old::PlayoutProcess(void *inRefCon,
                                   AudioUnitRenderActionFlags *ioActionFlags,
                                   const AudioTimeStamp *inTimeStamp,
                                   UInt32 inBusNumber,
                                   UInt32 inNumberFrames,
...
OSStatus
    AudioDeviceIOS_Old::PlayoutProcessImpl(uint32_t inNumberFrames,
                                       AudioBufferList *ioData) {
    // Setup some basic stuff
...
void AudioDeviceIOS_Old::UpdatePlayoutDelay() {
...
void AudioDeviceIOS_Old::UpdateRecordingDelay() {
...
bool AudioDeviceIOS_Old::RunCapture(void* ptrThis) {
    return static_cast<AudioDeviceIOS_Old*>(ptrThis)->CaptureWorkerThread();
}

bool AudioDeviceIOS_Old::CaptureWorkerThread() {
    if (_recording) {
        int bufPos = 0;
